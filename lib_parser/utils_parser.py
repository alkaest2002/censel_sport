...
def validate_file_path(filepath: str, type_of_request: Literal["analysis", "report"]) -> Path:
    ...
    Args:
        ...
        type_of_request: Type of file to validate, either "analysis" or "report".
...
def load_configuration_data(filepath: Path) -> Any:
    ...
    Args:
        filepath: Path to the JSON file containing configuration data.
    ...
    Raises:
        ...
        orjson.JSONDecodeError: If the file content is not valid JSON.
    """
