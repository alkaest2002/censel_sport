...
def _(pd, pdfplumber):
    ...
    def convert_to_df(tables, recrutiment_year):
        ...
        df = df.assign(recruitment_type="hd", recrutiment_year=recrutiment_year)
...
def _(document_to_parse, hd_2021, np):
    pages_2021 = document_to_parse(hd_2021)
...
def _(convert_to_df, output_path, tables_2021):
    ...
    df_2021.to_csv(output_path / "2021_hd_tables.csv", index=False)
    return
...
def _(document_to_parse, hd_2022, np):
    pages_2022 = document_to_parse(hd_2022)
...
def _(np, t_2022_0, t_2022_1):
    tables_2022 = []
    tables_2022.append(("m", "1000mt_run", t_2022_0[1:8,:2]))
    tables_2022.append(("m","sit_ups", np.c_[t_2022_0[1:8, 0], t_2022_0[1:8, -1]]))
    tables_2022.append(("m","100mt_run", t_2022_0[8:,:2]))
    tables_2022.append(("m", "push_ups", np.c_[t_2022_0[8:, 0], t_2022_0[8:, -1]]))
    tables_2022.append(("f", "1000mt_run", t_2022_1[1:8,:2]))
    tables_2022.append(("f","sit_ups", np.c_[t_2022_1[1:8, 0], t_2022_1[1:8, -1]]))
    tables_2022.append(("f","100mt_run", t_2022_1[8:,:2]))
    tables_2022.append(("f", "push_ups", np.c_[t_2022_1[8:, 0], t_2022_1[8:, -1]]))
    return (tables_2022,)
...
def _(convert_to_df, output_path, tables_2022):
    ...
    df_2022.to_csv(output_path / "2022_hd_tables.csv", index=False)
    return
...
def _(document_to_parse, hd_2023, np):
    pages_2023 = document_to_parse(hd_2023)
...
def _(np, t_2023_0, t_2023_1):
    ...
    tables_2023.append(("m", "push_ups", np.c_[t_2023_0[9:, 0], t_2023_0[9:, -2]]))
    ...
    tables_2023.append(("f", "push_ups", np.c_[t_2023_1[9:, 0], t_2023_1[9:, -2]]))
    return (tables_2023,)
...
def _(convert_to_df, output_path, tables_2023):
    ...
    df_2023.to_csv(output_path / "2023_hd_tables.csv", index=False)
    return
...
def _(document_to_parse, hd_2024, np):
    pages_2024 = document_to_parse(hd_2024)
...
def _(np, t_2024_0, t_2024_1):
    ...
    tables_2024.append(("m", "push_ups", np.c_[t_2024_0[9:, 0], t_2024_0[9:, -2]]))
    ...
    tables_2024.append(("f", "push_ups", np.c_[t_2024_1[9:, 0], t_2024_1[9:, -2]]))
    return (tables_2024,)
...
def _(convert_to_df, output_path, tables_2024):
    ...
    df_2024.to_csv(output_path / "2024_hd_tables.csv", index=False)
    return
...
def _(document_to_parse, hd_2024, np, pages_2024):
    pages_2025 = document_to_parse(hd_2024)
...
def _(np, t_2025_0, t_2025_1):
    ...
    tables_2025.append(("m", "push_ups", np.c_[t_2025_0[9:, 0], t_2025_0[9:, -2]]))
    ...
    tables_2025.append(("f", "push_ups", np.c_[t_2025_1[9:, 0], t_2025_1[9:, -2]]))
    return (tables_2025,)
...
def _(convert_to_df, output_path, tables_2025):
    ...
    df_2025.to_csv(output_path / "2025_hd_tables.csv", index=False)
    return
